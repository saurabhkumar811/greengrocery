...
const ProductDetails = () => {
    ...
    return product && (
        ...
        <div className="flex flex-col items-center mt-20">
          ...
          <button className="mx-auto cursor-pointer px-12 my-6 py-2.5 border rounded text-primary hover:bg-primary/10 transition"
           onClick={()=> navigate('/products')}>See more</button>
